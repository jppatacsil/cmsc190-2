          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li>                     
                    ...
                    <li>                     
                      <a class="active" href="<?php echo site_url('teachers/teacherActions/7')?>" ">
                          <i class="icon_ol"></i>
                          <span>View Logs</span>
                      </a>
                  </li>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-th-list"></i>Live Logs</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td>2012-37616</td>
                                  <td>IT1-BAH-0655284</td>
                                  <td>PATACSIL, JOHN PHILIP</td>
                                  <td>G-1L</td>
                                </tr>
                              </tbody>
                            </table>
