              ...
              <div class="row">
                  <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4">
                        <input type="date" name="examinationDate" max="2016-12-31">
                      </div>
                      </div>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                        ...
                                        <div class="form-group">  
                                          <td><center><button type="submit" href="form_exam.html" class="btn btn-primary btn-lg">
                                            Save Question
                                          </button></td></center>
                                        </div>
                                  </div>
                              ...
                              <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal-1" class="modal fade">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                              <h4 class="modal-title">Add Questions from Question Bank</h4>
                                          </div>
                                          <div class="modal-body">
                                             ...
                                             <td>Allan Turing</td>
                                                  ...
                                                  <div class="form-group">
                                                      <div class="col-lg-offset-2 col-lg-10">
                                                         <button type="submit" href="form_exam.html" class="btn btn-primary btn-lg btn-block">Save Question</button>
                                                      </div>
                                                  </div>
                                              </form>
